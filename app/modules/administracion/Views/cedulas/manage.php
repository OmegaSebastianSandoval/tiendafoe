	...
	<form class="text-left" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform;?>"  data-bs-toggle="validator">
		<div class="content-dashboard">
			...
			<?php if ($this->content->cedula) { ?>
				<input type="hidden" name="id" id="id" value="<?= $this->content->cedula; ?>" />
			<?php }?>
			<div class="row">
				...
				<div class="col-4 form-group">
					<label for="cupo_soat"  class="control-label">cupo_soat</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono  fondo-azul-claro " ><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" value="<?= $this->content->cupo_soat; ?>" name="cupo_soat" id="cupo_soat" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
			</div>
