            ...
            <div class="row">
                ...
                <?php if (($this->content->publicidad_seccion != 3) && ($this->content->publicidad_seccion != 2)) { ?>
                    ...
                    <?php if ($this->content->publicidad_seccion != 3 && $this->content->publicidad_seccion != 2) { ?>
                        ...
                        <div class="col-4 form-group" id="vid">
					...
					<br>
					<input type="checkbox" name="mostrarinfo" value="1" class="form-control switch-form" <?php if ($this->getObjectVariable($this->content, 'mostrarinfo') == 1) { echo "checked";} ?>   ></input>
					<div class="help-block with-errors"></div>
				</div>
                <?php } else { ?>
                    <div class="col-3 form-group">
