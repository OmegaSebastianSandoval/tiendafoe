...
class Administracion_Model_DbTable_Informacion extends Db_Table
{
	...
	public function update($data,$id){
		...
		$info_pagina_fechacierre = $data['info_pagina_fechacierre'];
		$info_pagina_fechaapertura = $data['info_pagina_fechaapertura'];
