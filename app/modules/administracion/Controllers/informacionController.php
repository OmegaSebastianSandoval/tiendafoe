...
class Administracion_informacionController extends Administracion_mainController
{
	...
	private function getData()
	{
		...
		$data['info_pagina_fechacierre'] = $this->_getSanitizedParam("info_pagina_fechacierre");
		$data['info_pagina_fechaapertura'] = $this->_getSanitizedParam("info_pagina_fechaapertura");
