	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="nivel">
	                        ...
	                        <?php foreach ($this->list_nivel as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'nivel') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
		            <label>cupo_inicial</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-azul " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="cupo_inicial" value="<?php echo $this->getObjectVariable($this->filters, 'cupo_inicial') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>cupo_actual</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-azul-claro " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="cupo_actual" value="<?php echo $this->getObjectVariable($this->filters, 'cupo_actual') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						...
						<td><?=$content->cupo_inicial;?></td>
						<td><?=$content->cupo_actual;?></td>
						<td class="text-right">
							<div>
