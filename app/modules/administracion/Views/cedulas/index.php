        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="cupo" value="<?php echo $this->getObjectVariable($this->filters, 'cupo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>cupo_soat</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-azul-claro " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="cupo_soat" value="<?php echo $this->getObjectVariable($this->filters, 'cupo_soat') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->cedula; ?>
					<tr>
						<td><?=$content->nombre;?></td>
						<td><?=$content->cupo;?></td>
						<td><?=$content->cupo_soat;?></td>
						<td class="text-right">
							<div>
