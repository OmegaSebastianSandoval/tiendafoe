...
class Administracion_cedulasController extends Administracion_mainController
{
	...
	{
		$title = "Aministración de cedulas";
	...
	/**
     * Genera la Informacion necesaria para editar o crear un  cedulas  y muestra su formulario
     *
     * @return void.
     */
	...
	/**
     * Inserta la informacion de un cedulas  y redirecciona al listado de cedulas.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y Actualiza la informacion de un cedulas  y redirecciona al listado de cedulas.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y elimina un cedulas  y redirecciona al listado de cedulas.
     *
     * @return void.
     */
	...
	private function getData()
	{
		...
		$data['cupo_soat'] = $this->_getSanitizedParam("cupo_soat");
		return $data;
	}
	/**
    ...
    protected function getFilter()
    {
        ...
        if (Session::getInstance()->get($this->namefilter)!="") {
            ...
            if ($filters->cupo_soat != '') {
                $filtros = $filtros." AND cupo_soat LIKE '%".$filters->cupo_soat."%'";
            }
		}
        return $filtros;
    }
    ...
    protected function filters()
    {
        if ($this->getRequest()->isPost()== true) {
            ...
            $parramsfilter = array();
					...
					$parramsfilter['cupo_soat'] =  $this->_getSanitizedParam("cupo_soat");Session::getInstance()->set($this->namefilter, $parramsfilter);
        }
