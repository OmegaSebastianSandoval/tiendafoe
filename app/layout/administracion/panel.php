...
<body>
    <header>
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-3">
                    <img src="/skins/administracion/images/logooscuro.png" class="logo-blanco" style="height: 80px;">
                </div>
                <div class="col-9">
    ...
    <footer class="panel-derechos col-md-12">&copy;<?php echo date('Y')?> Todos los derechos reservados | Diseñado por <a href="https://omegasolucionesweb.com" target="_blank" style="text-decoration:none;color:white"> Omega Soluciones Web
    </footer>
    <!-- Jquery -->
