				...
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="activo"
							value="<?php echo $this->getObjectVariable($this->filters, 'activo') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<select class="form-control" name="categoria">
							...
							<?php foreach ($this->list_categoria as $key => $value): ?>
								<option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'categoria') == $key) {
									  echo "selected";
								  } ?>>
									<?= $value; ?>
								</option>
					...
					<label class="input-group">
						...
						<select class="form-control" name="n1">
							...
							<?php foreach ($this->list_n1 as $key => $value): ?>
								<option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'n1') == $key) {
									  echo "selected";
								  } ?>>
									<?= $value; ?>
								</option>
				...
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="codigo"
							value="<?php echo $this->getObjectVariable($this->filters, 'codigo') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Marca</label>
					<label class="input-group">
						...
						<select class="form-control" name="marca">
							...
							<?php foreach ($this->list_marca as $key => $value): ?>
								<option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'marca') == $key) {
									  echo "selected";
								  } ?>>
									<?= $value; ?>
								</option>
				...
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="imagen"
							value="<?php echo $this->getObjectVariable($this->filters, 'imagen') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Precio</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="precio"
							value="<?php echo $this->getObjectVariable($this->filters, 'precio') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
			...
			<table class=" table table-striped  table-hover table-administrator text-left">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						...
						<tr>
							<!-- <td>
								<?= $content->activo == 1 ? 'Activo' : 'Inactivo'; ?>
							</td> -->
							<td class="cut-name">
								<?= $this->list_categoria[$content->categoria]; ?>
							<td class="cut-name">
								<?= $this->list_n1[$content->n1]; ?>
							<td class="cut-name">
								<?= $content->codigo; ?>
							</td>
							<td class="cut-name">
								<?= $this->list_marca[$content->marca]; ?>
							<td class="cut-name">
								<?= $content->nombre; ?>
							</td>
							<td>
							...
							<td>
								<?= $this->list_distribuidor[$content->distribuidor]; ?>
