			...
			<div class="row">
				...
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->producto; ?>" name="producto" id="producto" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
				...
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->enviado; ?>" name="enviado" id="enviado" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
