	...
	<form class="text-left" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform;?>"  data-bs-toggle="validator">
		<div class="content-dashboard">
			...
			<div class="row">
				...
				<div class="col-12 form-group">
					<label for="cedula2"  class="control-label">cedula2</label>
					<label class="input-group">
						<div class="input-group-prepend">
				...
				<div class="col-12 form-group">
					<label for="nombre2"  class="control-label">nombre2</label>
					<label class="input-group">
						<div class="input-group-prepend">
				...
				<div class="col-12 form-group">
					<label for="ciudad2"  class="control-label">ciudad2</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono  fondo-morado " ><i class="fas fa-pencil-alt"></i></span>
						</div>
				...
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->placa; ?>" name="placa" id="placa" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
				...
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->cilindraje; ?>" name="cilindraje" id="cilindraje" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
				...
				<div class="col-12 form-group">
					<label for="valor_soat"  class="control-label">valor_soat</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono  fondo-verde-claro " ><i class="fas fa-pencil-alt"></i></span>
						</div>
				...
				<div class="col-12 form-group">
					<label for="valor_descuento"  class="control-label">valor_descuento</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono  fondo-rojo-claro " ><i class="fas fa-pencil-alt"></i></span>
						</div>
				...
				<div class="col-12 form-group">
					<label for="fecha_vencimiento_soat"  class="control-label">fecha_vencimiento_soat</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono  fondo-verde " ><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" value="<?= $this->content->fecha_vencimiento_soat; ?>" name="fecha_vencimiento_soat" id="fecha_vencimiento_soat" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->archivo; ?>" name="archivo" id="archivo" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
				...
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->cuota; ?>" name="cuota" id="cuota" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
