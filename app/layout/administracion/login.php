...
<body class="login-fondo">
  ...
  <div class="login-derechos">&copy;<?php echo date('Y')?> Todos los derechos reservados | Diseñado por <a href="https://omegasolucionesweb.com" target="_blank" style="text-decoration:none;color:white"> Omega Soluciones Web
  </div>
