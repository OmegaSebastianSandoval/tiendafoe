        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="config_fechacierre" value="<?php echo $this->getObjectVariable($this->filters, 'config_fechacierre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="config_fechaapertura" value="<?php echo $this->getObjectVariable($this->filters, 'config_fechaapertura') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->config_id; ?>
					<tr>
						<td><?=$content->config_fechacierre;?></td>
						<td><?=$content->config_fechaapertura;?></td>
						<td class="text-right">
							<div>
								...
								<span class="d-none"  data-bs-toggle="tooltip" data-placement="top" title="Eliminar"><a class="btn btn-rojo btn-sm"  data-bs-toggle="modal" data-bs-target="#modal<?= $id ?>"  ><i class="fas fa-trash-alt" ></i></a></span>
							</div>
							<!-- Modal -->
